            ...
            <div class="col-lg-5">
                ...
                <form class="form-signin" action="validacion.php" method="POST">
                    ...
                    <a href="https://www.google.com/?hl=es" target="_blank"
                        class="form-check-label text-muted text-decoration-none">¿Has Olvidado Tu Contraseña?</a>
                    ...
                    <div class="container p-4">
                        ...
                        <section>
                            <form>
                                ...
                                <div>
                                    <p>
                                        No somos una empresa, sólo un grupo de profesionales independientes creciendo y
                                        trabajando juntos.
                                    </p>
                                </div>
                            </form>
