...
$id_pregunta = $_GET['id_pregunta']; //probar poniendo en el otro mostrarOpciones con el otro id
            ...
            <div class="col-md-12 row">
                ...
                <div class="col-md-2 col-xs-12">
                    <div class="btn-group">
                        ...
                        <div class="col-md-5">
                            <a class="btn btn-warning" href="mostrar_preguntas.php?id_encuesta=<?php echo $id_encuesta ?>" role="button" style="color: white;">Regresar</a>
                        </div>
...
<div class="modal fade" id="modal_modificar" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-primary" onclick="modificarDetallesOpcion()">Modificar
                    Opción</button>
